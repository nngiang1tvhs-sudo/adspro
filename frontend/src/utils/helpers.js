...
export const DEFAULT_COLUMNS = {
  google: [
    ...
    { key: 'spend', label: 'Chi phí', visible: true, format: 'currency' },
    { key: 'video_views', label: 'TrueView', visible: true, format: 'number' },
    { key: 'cpv', label: 'CPV', visible: true, format: 'currency' },
    { key: 'conversions', label: 'Chuyển đổi', visible: true, format: 'number' },
  ...
  facebook: [
    ...
    { key: 'spend', label: 'Chi phí', visible: true, format: 'currency' },
    { key: 'conversions', label: 'Kết quả', visible: true, format: 'number' },
  ...
  tiktok: [
    ...
    { key: 'result', label: 'Kết quả', visible: true, format: 'number' },
    { key: 'cost_per_result', label: 'CP/KQ', visible: true, format: 'currency' },
